...
console.log(date.getDay());
    ...
    useEffect(()=>{
        axiosInstance.post(`/viewComingBookingforStaff/${id}`)
        .then((response)=>{
                ...
                <div class="row g-4">
                    {
                        ...
                        <div class="d-flex cat-item rounded p-4 justify-content-around"  >
                            ...
                            <p>{a.date}</p>
                            <p>{a.time}</p>
                            {/* <Link class="btn btn-success py1 px3 mt-3 " to={`/staff_add_result/${a._id}`} style={{marginRight:'3px'}} >Add result</Link> */}
