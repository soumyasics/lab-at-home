...
function Doctorlogin() {
    ...
    const changehandleSubmit  = (a)=> {
      ...
      const submitt=(b)=>{
        ...
        b.preventDefault()
        axiosInstance.post('/loginDoctor',login)
        .then((result)=>{
          console.log('data entered',result)
          if (result.status==200) {
            navigate('/DocHome')
            localStorage.setItem("doctlogid", result.data.user._id);
                        ...
                        <form onSubmit={submitt}>
                            ...
                            <div class="col-lg-12 loginbttm">
                                ...
                                <div class="col-lg-12 login-btm login-button mt-2">
                                 ...
                                 <p>Don't have an Account? <Link to="/DoctorReg" class="reg text-success">Register</Link></p>
                                 <p><Link to="/Doc_forgot_pass" class="reg text-success">Forgot Password</Link></p>
