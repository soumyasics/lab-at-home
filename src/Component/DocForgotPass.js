...
function DocForgotPass() {
    ...
    const onSubmit=(e)=>{
        ...
        axiosInstance.post("/forgetPwdDoctor",values)
        .then((response)=>{
                    ...
                    <div class="col-lg-12 login-form">
                        <form onSubmit={handleSubmit}>
                            ...
                            <div class="form-group  mb-3">
                                ...
                                <input 
                                type="password" class="form-control" value={values.password} onChange={handleChange} onBlur={handleBlur} id="password" placeholder="Password"
                                />
                            </div>
